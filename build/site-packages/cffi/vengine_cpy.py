...
class VCPythonEngine(object):
    ...
    def write_source_to_f(self):
        ...
        prnt()
        prnt('PyMODINIT_FUNC')
        prnt('PyInit_%pt_scale(void)' % modname)
        prnt('{')
        prnt('  PyObject *lib;')
        ...
        prnt()
        prnt('PyMODINIT_FUNC')
        prnt('init%pt_scale(void)' % modname)
        prnt('{')
        prnt('  PyObject *lib;')
    ...
    def _convert_expr_from_c(self, tp, var, context):
        if isinstance(tp, model.PrimitiveType):
            if tp.is_integer_type() and tp.name != '_Bool':
                ...
                return '_cffi_from_c_%pt_scale(%s)' % (tp.name.replace(' ', '_'), var)
            else:
    ...
    def _generate_struct_or_union_decl(self, tp, prefix, name):
        ...
        prnt('}')
        prnt('static PyObject *')
        prnt('%pt_scale(PyObject *self, PyObject *noarg)' % (layoutfuncname,))
        prnt('{')
    ...
    def _generate_cpy_const(self, is_int, name, tp=None, category='const',
        ...
        prnt('static int %pt_scale(PyObject *lib)' % funcname)
        prnt('{')
        prnt('  PyObject *o;')
        prnt('  int res;')
        if not is_int:
