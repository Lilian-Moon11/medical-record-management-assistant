...
[
  {{"field_key": "core.name", "value": "John Doe", "confidence": 1.0}},
  {{"field_key": "vitals.list", "value": {{"name": "Weight", "value": "150", "unit": "lbs", "date": "2023-01-01"}}, "confidence": 0.9}}
]
...
medicationstatement.current_list — ALL medications (active and discontinued). Set "is_current" to true for active, false for discontinued. Includes: prescriptions, OTC drugs, supplements, injections like Depo-Provera.
...
insurance.list — Insurance payer name, member ID, group number. Hospital names and medical record numbers are providers, and go in providers.list.
...
Rules:
1. Every value must come directly from the document text. Do not invent dates; if a vital or lab is listed, use the date of the visit from the section headers, NOT the date the document was printed.
